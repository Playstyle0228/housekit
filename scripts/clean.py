...
#
# 這裡刻意不含「預售屋、或土地及建物分件登記案件」。該備註曾被當作交屋遞延的
# 代理指標，但只在烏日成立：烏日 115S2 有此備註者遞延 21~49 個月、無此備註者
# -2~7 個月，兩者完全分離；南屯 115S2 卻是有備註 2~55 個月、無備註 -2~57 個月，
# 完全重疊——因為該備註是「預售屋」OR「土地及建物分件登記」，後者是登記作業
# 形式，正常成屋交易也會出現。以它剔除會誤刪南屯遞延僅 2 個月的當期成交
# （115S2 單季 486 筆）。遞延一律交由 clean_row() 的 max_lag_months 判斷。
SPECIAL_REMARKS = [
    "親友", "員工", "共有人", "特殊關係", "關係人",
    "政府機關標讓售", "協議價購", "標售", "標讓售",
    "僅車位交易", "市場攤位", "毛胚屋",
